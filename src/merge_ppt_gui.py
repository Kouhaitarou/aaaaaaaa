...
import sys
import copy
from tkinter import Tk, Listbox, Button, END, filedialog, Text, Scrollbar, VERTICAL, RIGHT, Y, LEFT, BOTH
...
class App:
    ...
    def edit_toc(self):
        ...
        self.toc_text.pack()
        Button(self.toc_window, text='Close', command=self.toc_window.destroy).pack()
